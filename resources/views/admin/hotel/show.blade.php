            ...
            <div class="card-body">
                <form>
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <textarea name="direccion" cols="15" rows="5" class="form-control" readonly>{{ $hotel->direccion }}</textarea>
                                </div>
                            </div>
                        </div>
                        <!--/row-->
                    ...
                    <div class="form-actions">
                        <a href=" {{ route('hotel.edit', $hotel->id) }} " class="btn waves-effect waves-light btn-success">
                            <i class="ti-pencil"></i>
                            Editar Datos</a>
